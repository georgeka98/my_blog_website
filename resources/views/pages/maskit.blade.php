...
@section('content')
        <div class="about-section ">
            ...
            <div class="text-center">
              ...
              <p style="font-size: 1rem">MaskIt presentation at the Hack 4 the People Presentation day on the 23th of August 2020.</p>
            </div>
            ...
            <p>Through the mentorship program, we were assigned by a Software Engineer from Google. who helped us take the idea from the very beginning to the very end. We begun with brainstorming, prioritization features for a prototype, creating a timeline and offered us a general guidance when it came with technology choices, as well as giving us consitent feedback on the design of the app.</p>

            <p>Eventually, <a href="https://events.withgoogle.com/demo-week-hackathon-fund/#content">we were one of the 13 teams</a> invited to present what we have done throughout the mentorship program to a panel of judges from Google in May 2020. This is the first Hackathon I win after participating 6 more in the past without receiving a recognition. When I joined my first Hackathon, I was came to the last place. After joining more, I learned how to better work with people under pressure and became a better communicator.</p>
